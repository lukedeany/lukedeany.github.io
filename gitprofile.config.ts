  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['lugatuic/MVMT-Dont-Be-Scared-2025', 'ld-uic/sparkhacks-2025-scheduler'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
